...
#to work all of your annotation dataset must be 
#written in one file like this 
#foto00088.png,496,261,737,411
annotation_path = 'your_annotation_dataset'
...
for row in rows:
	...
	# path 
	image_path = 'dataset/final_dataset'
...
model.save(config.MODEL_PATH_v2, save_format="h5")
...
plt.savefig(config.PLOT_PATH_v2)